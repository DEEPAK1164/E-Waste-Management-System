...
//Card Details are Here
      ...
      {/* {fetcheddata.length > 0 && (
        <div className="w-full mt-[2vh]">
          <h1 className="mb-[5vh] font-montserrat font-bold text-2xl">Search Results</h1>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {fetcheddata.slice(0, 12).map((item, index) => (
              <div
                key={index}
                className="h-full shadow-3xl p-4 rounded-lg bg-[#ff5757] md:max-w-[60vh]"
              ...
              >
                ...
                <button className="hover:bg-[#ff5757] mt-[2vh] hover:scale-105 shadow-3xl transition-transform font-montserrat font-semibold p-2 rounded-lg w-fit">
                  Go
                </button>
              </div>
            ))}
